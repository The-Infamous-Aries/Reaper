...
if TYPE_CHECKING:
    from PIL import Image as _PILImage, ImageDraw as _PILImageDraw, ImageFont as _PILImageFont, ImageChops as _PILImageChops, ImageFilter as _PILImageFilter
    Image = _PILImage
    ImageDraw = _PILImageDraw
    ImageFont = _PILImageFont
    ImageChops = _PILImageChops
