...
class SlotMachineView(discord.ui.View):
    ...
    async def perform_spin(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            title=f"🎰 PET XP SLOTS - {self.difficulty.upper()} 🎰",
        ...
        for stage_num, status in enumerate(animation_stages):
            try:
                ...
                if is_insanity:
                    ...
                    elements_display = f"🎰  {current_slots_elements[0]}  {current_slots_elements[1]}  {current_slots_elements[2]}  🎰"
                    species_display = f"🎰  {current_slots_species[0]}  {current_slots_species[1]}  {current_slots_species[2]}  🎰"
    ...
    async def show_results_insanity(self, element_reel_set: List[str], species_reel_set: List[str], element_symbol: str, species_symbol: str):
        ...
        elements_display = f"🎰  {emoji_slots[0]}  {emoji_slots[1]}  {emoji_slots[2]}  🎰"
        species_display = f"🎰  {pet_slots[0]}  {pet_slots[1]}  {pet_slots[2]}  🎰"
