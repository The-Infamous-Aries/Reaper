...
class LootCalculator:
        ...
        try:
            ...
            if material_names:
                ...
                if missing_materials:
                    msg_parts.append(f"❌ Missing Material(s): {', '.join(missing_materials)}")
    ...
    def generate_hostile_pet(player_pet: dict, difficulty: str) -> dict:
        ...
        player_stats = StatsCalculator.calculate_pet_stats(player_pet)
