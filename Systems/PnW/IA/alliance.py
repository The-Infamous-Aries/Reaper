...
class ImprovementsView(discord.ui.View):
    ...
    async def generate_improvements_embed(self, nations: List[Dict] = None) -> discord.Embed:
        ...
        try:
            ...
            embed = discord.Embed(
                title="🏗️ DB4D Improvements Breakdown",
