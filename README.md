...
- **[REAPER.md](REAPER.md)** — Complete documentation for the Reaper Discord bot, including architecture, component breakdown, command reference, web interface details, and development guidelines.
