...
class LootCalculator:
    ...
    async def award_loot_items(user_id: int, pet_data: Dict[str, Any], difficulty: str = "normal", level: int = 1, source: str = "battle") -> Dict[str, Any]:
        ...
        # 1. Keys (Available in all sources)
        # Note: Missions use get_key_loot directly in perform_mission for multi-roll.
        # This award_loot_items is used by calculate_loot for battles.
        # If it's a mission, we respect the "Keys Only" rule.
        ...
        if source != "mission":
            # Battles/Training/etc. can loot other things
            # Materials
...
class DamageCalculator:
    ...
    def calculate_battle_action(
        ...
        attacker_element2: str = None,
        defender_type: str = None,
        defender_element: str = None,
        defender_element2: str = None,
    ...
    @staticmethod
    def compute_element_bonus(attacker_element: str, defender_element: str, attacker_element2: Optional[str] = None, defender_element2: Optional[str] = None) -> float:
        """
