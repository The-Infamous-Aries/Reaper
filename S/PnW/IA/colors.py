...
class GameInfoCog(commands.Cog):
    ...
    def __init__(self, bot: commands.Bot, query_instance: Optional[PNWAPIQuery] = None):
        self.bot = bot
        ...
        self.query_instance = query_instance or create_query_instance(logger=self.logger)
