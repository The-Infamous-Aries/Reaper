...
class SearchNationImprovementsView(discord.ui.View):
    ...
    async def generate_nation_improvements_embed(self) -> Optional[discord.Embed]:
        ...
        try:
            ...
            nuclear_power = improvements.get('nuclear_power', 0)
            wind_power = improvements.get('wind_power', 0)
            total_power = improvements.get('total_power', 0)
            
            power_improvements = [
                f"**Coal Power:** {coal_power:,}",
                f"**Oil Power:** {oil_power:,}",
                f"**Nuclear Power:** {nuclear_power:,}",
                f"**Wind Power:** {wind_power:,}",
            ...
            resource_improvements = [
                f"**Coal Mines:** {coal_mine:,}",
                f"**Oil Wells:** {oil_well:,}",
                f"**Uranium Mines:** {uranium_mine:,}",
                f"**Iron Mines:** {iron_mine:,}",
                f"**Bauxite Mines:** {bauxite_mine:,}",
                f"**Lead Mines:** {lead_mine:,}",
                f"**Farms:** {farm:,}",
                f"**Steel Mills:** {steel_mill:,}",
                f"**Aluminum Refineries:** {aluminum_refinery:,}",
                f"**Munitions Factories:** {munitions_factory:,}",
                f"**Oil Refineries:** {oil_refinery:,}",
            ]
            ...
            civil_improvements = [
                f"**Police Stations:** {police_station:,}",
                f"**Hospitals:** {hospital:,}",
                f"**Recycling Centers:** {recycling_center:,}",
                f"**Subways:** {subway:,}",
                f"**Supermarkets:** {supermarket:,}",
                f"**Banks:** {bank:,}",
                f"**Shopping Malls:** {shopping_mall:,}",
                f"**Stadiums:** {stadium:,}"
            ]
