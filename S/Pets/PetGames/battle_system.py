...
class UnifiedBattleView(discord.ui.View):
    ...
    async def create_async(cls, ctx, battle_type="solo", participants=None, 
        ...
        await view.regenerate_enemy_for_difficulty()
    ...
    async def regenerate_enemy_for_difficulty(self):
        ...
        if first_pet:
            self.monster = self._generate_enemy_for_pet(first_pet, self.difficulty)
            if self.monster:
